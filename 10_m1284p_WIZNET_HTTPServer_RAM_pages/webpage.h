...
#define wiz550web_dio_js	\
							...
							"function setDiostate(o){"\
								...
								"dout=new AJAX('set_diostate.cgi', function(t){try{/*eval(t);*/document.getElementById('led1_txt').innerHTML = t;}catch(e){alert(e);}});"\
							...
							"function getled1(){"\
								 "var oUpdate;"\
								 "setTimeout(function(){"\
									"oUpdate=new AJAX('get_led1.cgi',function(t){"\
										"try{eval(t);}catch(e){alert(e);}"\
								 "});"\
								 "oUpdate.doGet();},300);"\
...
"  </div><br>\n"\
"  <a href='netinfo.html'>Network Information</a><br>\n"\
"  <a href='img.html'>Base64 Image Data</a><br>\n"\
"  <br>\n"\
"  <a href='dio.html'>Ex1&gt; Digital I/O</a><br>\n"\
"  <a href='ain.html'>Ex2&gt; Analog Input</a><br>\n"\
"  <a href='ain_gauge.html'>Ex3&gt; Analog Input: Google Gauge Chart</a><br>\n"\
"  <br>\n"\
"  <a href='info.html'>Device Information</a><br>\n"\
"</body>\n"\
"</html>\n"\
""
#define wiz550web_info_js \
"function getInfo()\n"\
"{\n"\
" var oUpdate;\n"\
" setTimeout(function()\n"\
...
#define dio_page  			"<!DOCTYPE html>"\
							"<html>"\
								...
								"<body onload='getled1();'>"\
									...
									"<input type='button' value='LED 1 On' pin='LED1' s= '1' onclick='setDiostate(this);'>"\
									"<br>"\
									"</div>"\
									"<!-- to do -->"\
								"</body>"\
							...
							"<html>"\
								...
								"<body>"\
									...
									"<div>"\
										...
										"<input type='button' value='Get AIN6 Auto' onclick='getAin6_update();'> "\
										"<br>"\
...
//!! No space at RAM in AtMega1284p (16kb only..)
//!! Need replace all pages into FLASH memory (PROGMEM) - Shame AVR-8bit HARVARD Architecture!!
/*
...
#define img_page			"<!DOCTYPE html>"\
							"<html>"\
								"<head>"\
								"<title>W5500-AtMEGA1284p Web Server Image</title>"\
								"<meta http-equiv='Content-Type' content='text/html; charset=utf-8' />"\
								"<meta http-equiv='pragma' content='no-cache' />"\
								"<meta http-equiv='content-type' content='no-cache, no-store, must-revalidate' />"\
								"</head>"\
