...
/*
 * (18) Base template minimal for FTPD bootloaded application with TCP/IP loopback demo (m644p)
 * TODO:
 * OK (v1.1) Add FTPD authentication abilities
...
#ifdef BOOT_EN
	//Delete <644BOOT.BIN> for BootLoader working properly
	fatfs_delete("644BOOT.BIN");
	//Test message
